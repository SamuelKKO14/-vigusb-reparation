...
export function Hero({ ville, magasin }: Props) {
  return (
    <section className="bg-violet px-4 pt-10 pb-8 md:pt-16 md:pb-12">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 border-2 border-white text-white font-bold text-base px-6 py-3.5 rounded-lg hover:bg-white/10 transition-colors"
          >
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-sm text-white/85">
          <span className="flex items-center gap-1">
            <span className="text-green">★</span> 4,8/5
          </span>
